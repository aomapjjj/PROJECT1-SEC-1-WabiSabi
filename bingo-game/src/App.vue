...
<template>
  <div class="relative w-full h-full">
    ...
    <!-- Audio -->
<div v-else class="relative z-10 flex flex-row w-full h-full">
    ...
    <div class="absolute top-6 right-6 flex items-center">
      <button @click="playMusic" v-show="showAudio">
        ...
        <div class="flex flex-col items-center mt-6">
          <div class="p-3 shadow-md rounded-full w-16 h-16 text-center border border-neutral-950 border-r-4">
        ...
        <div class="flex flex-col items-center mt-8">
          ...
          <div class="relative p-6 border-4 border-blue-500 rounded-md bg-white shadow-xl flex items-center justify-center w-auto min-w-max">
